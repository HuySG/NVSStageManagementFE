...
const MilestoneListPage = () => {
  ...
  // Lấy toàn bộ request và detail project (lấy danh sách milestone)
  ...
  // Map milestoneID => title (từ details)
  ...
  // Gom milestone, chỉ request của staff hiện tại
  ...
  }, [requests, projectId, milestoneTitleMap, userId]);

  // Tổng milestone, tổng request của staff này
    ...
    <div className="min-h-screen bg-gray-50 px-0 py-0 dark:bg-gray-900">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Chọn milestone để xem chi tiết các yêu cầu bạn đã gửi trong từng
              giai đoạn dự án.
            </p>
          </div>
      ...
      <main className="px-10 pb-10">
        {loadingRequests || loadingProject ? (
          ...
          <div className="py-20 text-center text-lg text-gray-400">
            Bạn chưa gửi yêu cầu nào trong dự án này.
          </div>
        ) : (
            ...
            {milestoneMap.map(([milestoneId, { title, count }]) => (
              ...
              >
                ...
                <div className="text-xs text-gray-600 dark:text-gray-200">
                  Nhấn để xem các yêu cầu đã gửi trong milestone này.
                </div>
              </Link>
            ))}
          </div>
